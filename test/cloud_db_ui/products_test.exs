defmodule CloudDbUi.ProductsTest do
  ...
  describe "products" do
    ...
    test "list_products_with_type_and_order_count/0 returns all w/ preloads",
      ...
      assert(Products.list_products_with_type_and_order_count() == [prod_new])
    end
  ...
  describe "product_types" do
    ...
    test "list_product_types/0 returns all product_types", %{type: type} do
      assert Products.list_product_types() == [type]
    end
