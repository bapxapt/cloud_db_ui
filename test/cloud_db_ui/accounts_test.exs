defmodule CloudDbUi.AccountsTest do
  ...
  @valid_attrs %{
    email: "user_a_b_c_d@user_a_b_c_d.pl",
    email_confirmation: "user_a_b_c_d@user_a_b_c_d.pl",
    password: "Test123.",
  ...
  describe "register_user/1" do
    ...
    test "validates an e-mail and a password when given" do
      ...
      assert(errs_email == ["must have the @ sign and no spaces"])
  ...
  describe "apply_user_email/3" do
    ...
    test "validates the e-mail address", %{user: user} do
      ...
      assert(%{email: ["must have the @ sign and no spaces"]} = errors_on(set))
    end
