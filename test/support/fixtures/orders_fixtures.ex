defmodule CloudDbUi.OrdersFixtures do
  ...
  def suborder_fixture(attrs \\ %{}) do
    ...
    prod = Map.get_lazy(attrs, :product, &product_fixture/0)
    ...
    {:ok, suborder} = CloudDbUi.Orders.create_suborder(attrs_new, order, prod)
  ...
  @spec change_to_paid(%Order{}, %User{}, %DateTime{}) :: %Order{}
  def change_to_paid(
        %{paid_at: nil} = order,
        user,
    ...
    {:ok, updated} =
      Orders.update_order(order, %{paid: true, paid_at: at}, user)
