defmodule CloudDbUiWeb.UserSettingsLive do
  ...
  # TODO: do not show "does not match confirmation" for the e-mail confirmation:
    # TODO: while the e-mail confirmation field is focused,
      # TODO: and the new trimmed and down-cased e-mail .starts_with() the trimmed and down-cased confirmation
    # TODO: until the e-mail confirmation field is unfocused or the "Save" button is hit,
      # TODO: and the e-mail confirmation really does not match the e-mail
  ...
  defp label_text_email(%Form{} = form) do
    label_text("E-mail address", form[:email].value, 160)
  end
