defmodule CloudDbUiWeb.CoreComponents do
  ...
  def show_modal(js \\ %JS{}, id) when is_binary(id) do
    js
    |> JS.show(to: "##{id}")
    |> JS.show(to: "##{id}-bg", transition: show_modal_transition())
    |> show("##{id}-container")
  ...
  def hide_modal(js \\ %JS{}, id) do
    js
    |> JS.hide(to: "##{id}-bg", transition: hide_modal_transition())
    |> hide("##{id}-container")
  ...
  @doc """
  Return a base button class to be used with `<.link>`.
  """
  ...
  @spec show_modal_transition() :: {String.t(), String.t(), String.t()}
  defp show_modal_transition() do
    {
      "transition-all transform ease-out duration-300",
      "opacity-0",
      "opacity-100"
  ...
  @spec hide_modal_transition() :: {String.t(), String.t(), String.t()}
  defp hide_modal_transition() do
    {
      "transition-all transform ease-in duration-200",
      "opacity-100",
      "opacity-0"
