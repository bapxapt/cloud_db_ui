defmodule CloudDbUiWeb.Router do
  ...
  if Application.compile_env(:cloud_db_ui, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CloudDbUiWeb.Telemetry
  ...
  # TODO: check direct links
    # TODO: /users/:id/edit (also check with an admin)
    # TODO: /users/:id/show/edit (also check with an admin)
    # TODO: /product_types/:id/edit
    # TODO: /product_types/:id/show/edit
    # TODO: /products/:id/edit
    # TODO: /products/:id/show/edit
    # TODO: /orders/:id/edit (also check with a paid order)
    # TODO: /orders/:id/show/edit (also check with a paid order)
    # TODO: /orders/:id/pay (also check with a paid order)
    # TODO: /orders/:id/show/pay (also check with a paid order)
    # TODO: /orders/:id/show/:s_id/edit (also check with a paid order)
    # TODO: /sub-orders/:id/edit (also check with a sub-order of a paid order)
    # TODO: /sub-orders/:id/show/edit (also check with a sub-order of a paid order)
