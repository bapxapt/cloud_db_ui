defmodule CloudDbUi.Products.ProductType do
  ...
  @doc false
  @spec validation_changeset(%__MODULE__{}, attrs(), boolean(), errors()) ::
          %Ecto.Changeset{}
  def validation_changeset(type, attrs, validate_unique?, errors) do
    type
  ...
  @doc false
  @spec saving_changeset(%__MODULE__{}, attrs()) :: %Ecto.Changeset{}
