...
config :cloud_db_ui, CloudDbUiWeb.ImageServer,
  hostname: System.get_env("IMAGE_SERVER_HOST", "localhost:4001/mock"),
  token_ro: System.get_env("IMAGE_SERVER_RO_TOKEN", "mock_token_ro_6e725b"),
  token_rw: System.get_env("IMAGE_SERVER_RW_TOKEN", "mock_token_rw_b4a3c0")
