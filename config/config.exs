...
config :flop, repo: CloudDbUi.Repo

config :flop_phoenix,
  table: [opts: {CloudDbUiWeb.CoreComponents, :table_opts}],
  pagination: [opts: {CloudDbUiWeb.CoreComponents, :pagination_opts}]
