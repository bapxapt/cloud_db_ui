...
#
#     PHX_SERVER=true bin/cloud_db_ui start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :cloud_db_ui, CloudDbUiWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :cloud_db_ui, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :cloud_db_ui, CloudDbUi.Mailer,
